...
documents](https://datatracker.ietf.org/wg/coap/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/coap/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/coap)). This will ensure that
